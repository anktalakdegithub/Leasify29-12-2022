            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" >
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" id="email" name="email-username" placeholder="Enter your Email Id" autofocus/>
                </div>
...
// alert("dangor");
                    ...
                    // window.location.href = "<?= base_url()?>/nbfc/resetpassword";
// alert('success');
