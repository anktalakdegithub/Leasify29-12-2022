            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" >
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" id="username" name="email-username" placeholder="Enter your Email Id" autofocus/>
                </div>
                ...
                <div class="mb-3">
                  <a href="<?=base_url();?>/user/forgotpassword">
                  <b class="text-secondary" >Forgot Password ?</b>
                  </a>
                </div>
                <div class="mb-3">
...
// alert("dangor");
                    ...
                    window.location.href = "<?= base_url()?>/user/rfqlist";
// alert('success');
