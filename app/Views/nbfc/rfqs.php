    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            ...
            <div class="row" id="load_data">
                <div class="col-md-12">
                    <h2 class="text-center fw-bold text-dark mt-md-5 mb-md-4">
                        Past Clients
                    </h2>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 my-2">

                    <div class="card h-100 cardsha">
                        <center><img src="<?=base_url();?>/public/assets/img/logo/Baskin-Robbins (1).png"
                                style="height: 100px;width: 90px;" class="card-img-top pt-3" alt="Baskin-Robbins">
                        </center>
                        <div class="card-body">
                            <h3 class="card-title text-center cardtitle">Baskin Robbins</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-2">
                    <div class="card h-100 cardsha">
                        <center><img src="<?=base_url();?>/public/assets/img/logo/bf.png"
                                style="height: 100px;width: 100%;" class="card-img-top pt-3" alt="Baskin-Robbins">
                        </center>
                        <div class="card-body">
                            <h3 class="card-title text-center cardtitle">Big Flex</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-2">
                    <div class="card h-100 cardsha">
                        <center><img src="<?=base_url();?>/public/assets/img/logo/mm.png"
                                style="height: 100px;width: 100%;" class="card-img-top pt-3" alt="Baskin-Robbins">
                        </center>
                        <div class="card-body">
                            <h3 class="card-title text-center cardtitle">Mailmodo</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-2">
                    <div class="card h-100 cardsha">
                        <center><img src="<?=base_url();?>/public/assets/img/logo/proto-d.png"
                                style="height: 100px;width: 100px;" class="card-img-top pt-3" alt="Baskin-Robbins">
                        </center>
                        <div class="card-body">
                            <h3 class="card-title text-center cardtitle">Proto-d Engineering</h3>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 my-2">
                    <div class="card h-100 cardsha">
                        <center><img src="<?=base_url();?>/public/assets/img/logo/bud-e.png"
                                style="height: 100px;width: 100px;" class="card-img-top pt-3" alt="Baskin-Robbins">
                        </center>
                        <div class="card-body">
                            <h3 class="card-title text-center cardtitle">bud-e</h3>
