                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item lh-1 me-3 my-2">

                                    <a href="<?=base_url();?>/user/rfqlist" class="menu-link text-dark fw-bold pt-1">
                                        <div data-i18n="Analytics">Active Deals</div>
                                    </a>
                                </li>
                                <!-- <li class="nav-item lh-1 me-3 my-2">
                                ...
                                <li class="nav-item lh-1 me-3 my-2">
                                    ...
                                    <a href="<?=base_url();?>/user/proposalsubmit" class="menu-link text-dark fw-bold pt-1">
                                        <div data-i18n="Analytics">Past Deals</div>
                                    </a>
                                </li>
                                <!-- <li class="nav-item lh-1 me-3 my-2">
                                ...
                                <li class="nav-item lh-1 me-3 my-2">
                                    ...
                                    <a href="<?=base_url();?>/user/order" class="menu-link text-dark fw-bold pt-1">
                                        <div data-i18n="Analytics">My Deals</div>
                                    </a>
                                </li>
                                <!-- <li class="nav-item lh-1 me-3 my-2">

                                    <a href="<?=base_url();?>/user/payment" class="menu-link text-dark fw-bold">
                                        <div data-i18n="Analytics">Repayment Schedule</div>
                                    </a>
                                </li> -->
                                <li class="nav-item lh-1 me-3 my-2">

                                    <a href="<?=base_url();?>/user/my_vault" class="menu-link text-dark fw-bold">
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                        ...
                        <div>
                            ...
                            <a href="<?=base_url();?>/terms" target="_blank" class="footer-link me-4">Terms & Condition</a>
                            <!-- 
                                <a href="https://themeselection.com/demo/sneat-bootstrap-html-admin-template/documentation/"
                                    target="_blank" class="footer-link me-4">Documentation</a> -->

                            <a href="<?=base_url();?>/policy" target="_blank" class="footer-link me-4">Privacy & Policy </a>
                        </div>
                    </div>
                </footer>
                <!-- / Footer -->
