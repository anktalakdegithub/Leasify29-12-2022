...
>
  ...
  <body>
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" >
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="password" name="password-username" placeholder="Enter your New password" autofocus/>
                </div>
                <div class="mb-3">
                  <label for="password" class="form-label"> Confirm Password</label>
                  <input type="password" class="form-control" id="cpassword" name="password-username" placeholder="Enter your Confirm password" autofocus/>
                </div>
            
               
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100 nbfclogin" type="button">Log in</button>
                </div>
              </form>
              <div id="msg"></div>
    ...
    $(".nbfclogin").click(function() {
        ...
        $.ajax({
            url: '<?=base_url();?>/nbfc/savenewresetpassword',
            data: {
                pass: pass
            },
            type: "post",
