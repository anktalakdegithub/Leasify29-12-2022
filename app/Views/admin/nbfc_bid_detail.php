...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">NBFC Detail Page</h4>
                                    ...
                                    <div class="modal-dialog modal-xl" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                <object data="<?=base_url();?>/public/assets/pdf/TATA-COMMUNICATIONS-INTERNET-LEASED-LINE-SERVICE-TARIF-.pdf" height="500px" type="application/pdf">
