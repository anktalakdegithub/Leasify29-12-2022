...
<head>
  ...
  <title>Leasify</title>
  <meta content="Leasify Admin" name="keywords">
    <meta content="Leasify Admin" name="description">
...
<!-- 
  <link rel="stylesheet" href="../assets/choices.js/choices.min.css" />

<script src="../assets/choices.js/choices.min.js"></script> -->
  <!-- Page CSS -->
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="index.php" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Leasify</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="investor.php" class="menu-link">
